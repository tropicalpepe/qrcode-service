...
set JARPATH=%APP_HOME%\lib\QRCode_Service-task.jar

@rem Execute QRCode_Service-task
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %QR_CODE_SERVICE_TASK_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%QR_CODE_SERVICE_TASK_EXIT_CONSOLE%" exit 1
exit /b 1
